...
def load_results():
    ...
    with open('output/muqattaat_theme_analysis.json', 'r') as f:
        theme = json.load(f)
    with open('output/muqattaat_distinctive_themes.json', 'r') as f:
...
def fig1_similarity_comparison(theme_results):
    ...
    plt.tight_layout()
    plt.savefig('output/figures/fig1_similarity.png', dpi=150, bbox_inches='tight')
    plt.savefig('output/figures/fig1_similarity.svg', bbox_inches='tight')
    plt.close()
...
def fig2_surah_map():
    ...
    plt.tight_layout()
    plt.savefig('output/figures/fig2_surah_map.png', dpi=150, bbox_inches='tight')
    plt.savefig('output/figures/fig2_surah_map.svg', bbox_inches='tight')
    plt.close()
...
def fig3_consecutive_pattern():
    ...
    plt.tight_layout()
    plt.savefig('output/figures/fig3_consecutive.png', dpi=150, bbox_inches='tight')
    plt.savefig('output/figures/fig3_consecutive.svg', bbox_inches='tight')
    plt.close()
...
def fig4_effect_size(theme_results):
    ...
    plt.tight_layout()
    plt.savefig('output/figures/fig4_effect.png', dpi=150, bbox_inches='tight')
    plt.savefig('output/figures/fig4_effect.svg', bbox_inches='tight')
    plt.close()
